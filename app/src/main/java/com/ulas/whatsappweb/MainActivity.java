...
import com.ulas.whatsappweb.TopstatusAdapter;
import com.ulas.whatsappweb.Status;
import com.ulas.whatsappweb.UserStatus;
import com.ulas.whatsappweb.R;
import com.ulas.whatsappweb.User;
import com.ulas.whatsappweb.UsersAdapter;
import com.ulas.whatsappweb.databinding.ActivityMainBinding;
...
//        binding.recyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.groups:
                startActivity(new Intent(MainActivity.this, ActivityGroupChat.class));
                break;
            case R.id.search:
